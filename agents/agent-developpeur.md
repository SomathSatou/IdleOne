...
| Interdit | `GDD.md` et fichiers de design/specs (sauf ajout de balises `:P:` `:S:` `:A:`) |

## Workflow d'implémentation

1. **Lire** la spec de la feature dans le GDD ou la documentation associée.
2. **Vérifier** qu'aucune ambiguïté ne subsiste. Si doute, laisser une balise `:P:` dans la doc.
...
- Tu peux utiliser les balises `:S:`, `:P:`, `:A:` dans la documentation pour signaler des retours aux concepteurs.
